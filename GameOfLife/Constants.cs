namespace GameOfLife
{
    public static class Constants
    {
        public static class Messages
        {
            ...
            public const string Start1000Games = "3. Start up to 1000 games and select 8 games to show on screen";
            public const string Load1000Games = "4. Load up to 1000 previously saved games and select 8 games to show on screen";
            public const string Exit = "5. Exit";
            public const string EnterSize = "Please enter the size of field.";
            public const string EnterGameCount = "Please enter the parallel run game count (1 - 1000).";
            ...
            public const string InvalidIndex = "Invalid game index";
